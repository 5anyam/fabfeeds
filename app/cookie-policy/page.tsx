...
export const metadata: Metadata = {
  title: 'Cookie Policy | Trendships',
  description: 'Learn about how Trendships uses cookies to improve your experience and show relevant content.',
};
          ...
          <div className="max-w-3xl mx-auto">
            <div className="prose prose-lg prose-gray max-w-none">
              ...
              <p className="lead text-xl text-gray-700 leading-relaxed mb-10">
                This Cookie Policy explains what cookies are, how <strong>Trendships</strong> uses them, and your choices regarding their use. By using our website, you consent to the use of cookies as described in this policy.
              </p>
