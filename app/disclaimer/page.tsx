...
export const metadata: Metadata = {
  title: 'Disclaimer - Terms & Conditions | Fab Feeds',
  description:
    'Read the disclaimer and terms of use for Fab Feeds. Understand our liability limitations, affiliate disclosure, and terms of service for our content platform.',
  keywords:
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    By accessing and using Fab Feeds, you accept and agree to be
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    The information provided on Fab Feeds is for general
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Fab Feeds participates in various affiliate marketing programs.
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    ...
                    Fab Feeds are based on personal research, experience, and
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Fab Feeds contains links to external websites and third-party
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    All content on Fab Feeds — including text, images, graphics,
                    logos, and multimedia elements — is protected by copyright and
                    intellectual property laws. The content is owned by Fab Feeds
                  ...
                  <ul className="list-disc list-inside space-y-2 pl-4">
                    ...
                    <li>Redistribute content from Fab Feeds without proper attribution</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    In no event shall Fab Feeds, its owners, authors, or
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Fab Feeds reserves the right to modify, suspend, or
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    ...
                    the views of Fab Feeds. We do not endorse or guarantee the
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    ...
                    professional information published on Fab Feeds is strictly
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <div className="border-l-4 border-black pl-6 my-6">
                    <p className="font-semibold text-gray-900">Fab Feeds</p>
                    <p>
                      Email:{' '}
                      <a
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    ...
                    any updates. Your continued use of Fab Feeds after any changes
